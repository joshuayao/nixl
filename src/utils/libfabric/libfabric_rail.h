...
public:
     ...
     * @param mem_type Memory type (VRAM_SEG or DRAM_SEG)
     ...
     */
    nixl_status_t
    registerMemory(void *buffer, size_t length, nixl_mem_t mem_type, const std::string &hmem_hint, int device_id, struct fid_mr **mr_out, uint64_t *key_out) const;
